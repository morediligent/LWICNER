...
class Data:
    def __init__(self):
        ...
        self.lexicon_label_alphabet = Alphabet('lexicon_label', True)
        ...
        self.lexicon_label_alphabet_size = 0
        ### hyperparameters
        ...
        self.HP_gpu = False
        self.HP_lr = 0.015
        self.HP_lr_decay = 0.05 #wwj
        self.HP_lr_decay_wwj = 1e-8
        self.HP_clip = 5.0
        self.HP_momentum = 0
    ...
    def show_data_summary(self):
        ...
        print(("     Hyperpara    HP_lr_decay_wwj: %s" % (self.HP_lr_decay_wwj)))
        if self.HP_use_char:
    ...
    def build_lexicon_alphabet(self):
        self.lexicon_label_alphabet.add('O')
        self.lexicon_label_alphabet.add('B-lexicon')
        self.lexicon_label_alphabet.add('M-lexicon')
        self.lexicon_label_alphabet.add('E-lexicon')
        self.lexicon_label_alphabet_size = self.lexicon_label_alphabet.size()
